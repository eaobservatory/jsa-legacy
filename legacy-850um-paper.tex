...
scale emission) was shown in \citet{Mairs2015}.
...
in the form of large bloom-like structures. Avoiding this problem was
the paramount consideration in developing the configuration for this
release. We found we could minimise the blooms of fake emission by not
attempting to recover the large scale structures in the map
($>$200\arcsec{}). When testing this configuration we discovered it
produced significantly better maps than some of the default values we
were using at the time, and we now use this configuration as our
default when projects do not select a more specific option.
...
subarray. We constrain the model of the astronomical signal (the AST
