...
\begin{abstract}
  ...
  The coadds and catalogs can be searched at CADC at:
...
coadded maps that required as little checking as possible by eye, and
...
observations,  as well as our standard pipeline reduced products. Unlike the
...
will  be returned as appropriate in searches based on spatial, temporal and
...
in the known sub-mm flux of Uranus (used to bootstrap \citet{Dempsey2013}'s
...
these outlines are available both as a FITS-format mask file, and as a
...
beam shape, and found the same shape and size as found in
