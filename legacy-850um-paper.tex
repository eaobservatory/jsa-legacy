...
\begin{figure*}
  ...
  \caption{Examples of the coadd, noise map, and extents towards the
    ...
    1244. This coadd contains XX900 observations (XXhrs elapsed
...
\begin{figure*}
  ...
  \caption{Tile 27258 showing an extrememly deep coadd towards a
    ...
    indicate the 1.75, 2,2.5,5,7.5 and 10 m\jyas\ regions. Bottom left: a zoom in on the deepest region of the map, showing the 850\micron\ data. The contour indicates the < 5m\jyas\ noise region. Bottom right: Comparison of the source catalogues produced here (shown as cyan crosses), as published in \citealt{Casey2013} (red circles) and as found by the JCMT CLS 850um DR1 \citep[blue triangles]{Geach2016}. }
  \label{fig:g34-3}
\end{figure*}
