...
\begin{abstract}
  ...
  of $~$1 degree a side, using the HPX projection onto pixels of area
...
paper (but calibrated using a slightly different FCF).
...
HPX tile, and catalogs of extended contiguous regions and local peaks
...
using a single FCF number. As Uranus being far brighter than anything
...
of 3-$\sigma$, to be a single `extent' for purposes of our reductions,
...
pointing observations, we identified that the average pointingoffset
...
\begin{figure*}
  ...
  \caption{The SCUBA-2 850\micron\ beam, as found from a deep coadd of Uranus
...
contrast.The yaxis shows the value relative to the full amplitude of
the beam.}
\label{fig:beam}
\end{figure*}
