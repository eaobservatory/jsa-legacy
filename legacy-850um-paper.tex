...
850\,\um wavelengths\citep{2013MNRAS.430.2513H}.
...
\citet{2014SPIE.9152E..2JB} found that more than fifty percent of
...
are more problematic \citep{SC19,2010SPIE.7741E..1XD}.  Observations by the JCMT Cosmology Legacy Survey
...
automated pipeline (\hl{ORAC-DR cite}), these relied on the PI for a
