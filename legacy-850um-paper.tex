...
\begin{abstract}
  ...
  conversion factor of 2.46. We discuss in detail the derivation of
  ...
  can be downloaded from \url{INSERT\ URL\ HERE}, along with masks
  showing the full area observecd in this release and the full area of
  detected emission.
\end{abstract}
...
Nearby Galaxy Survey \citep{NGLS}, and the Debris Disk Survey
\citep{SONS}.  Observations from earlier than 2011 February 2 were not
...
interface or through the VO-standard TAP protocol (which enables more
complex queries). The CADC TAP service can be easily queried from
within TOPCAT.
...
850\,\micron\ observations taken from 2012 to 2015, including coadded
