...
\author{Sarah F. Graves\altaffilmark{1,2,3},
     Graham S. Bell\altaffilmark{1,2},
     David S. Berry\altaffilmark{1,2},
     Iain M. Coulson\altaffilmark{1,2},
     Malcolm Currie\altaffilmark{2,4},
     Jessica T. Dempsey\altaffilmark{1,2},
     Per Friberg\altaffilmark{1,2},
     Tim Jenness\altaffilmark{2,4,4},
     Doug Johnstone\altaffilmark{2,4},
     Harriet A. L. Parsons\altaffilmark{1,2},
     Mark G. Rawlings\altaffilmark{1,2},
     Holly S. Thomas\altaffilmark{2},
     Craig A. Walther\altaffilmark{1,2}
    and Jan G. A. Wouterlout\altaffilmark{1,2}
}
\altaffiltext{1}{East Asian Observatory,660 N.\ A`oh\=ok\=u Place,Hilo, HI 96720, USA}
\altaffiltext{2}{Joint Astronomy Centre,660 N.\ A`oh\=ok\=u Place,Hilo, HI 96720, USA}
\altaffiltext{3}{s.graves@eaobservatory.org}
\altaffiltext{4}{Insert other affiliations}
...
Cosmology Legacy Survey \citep{Geach2013} are not included as they are
...
projects from all queues, were included if they fell in the given time
range.
...
\begin{table}
  \caption{Number and length of observations from various different
    categories of projects included in the co-added tiles in this
  ...
  {\noindent\scriptsize \textsuperscript{*} The percentage of all
    ...
    co-adds. The calculation of total time for a given type of project
...
\todo{Create plots illustrating healpix; also show effect on source}.
...
[Insert other acknowledgements here.]
\vspace{5mm}
