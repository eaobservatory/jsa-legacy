...
noise is 0.35 m\jyas. Table~\ref{tab:noises} shows the area of our
co-adds which has a noise level below various common values. This is
calculated by finding the number of pixels which have a noise value
less than or equal to a given limit. For convenience of those readers
...
JCMT `standard' beam FCF (537 Jy\,beam$^{-1}$\,pW$^{-1}$. Please note
...
\begin{deluxetable}{rc r c c p{2cm}}
  \tablecaption{\todo{Reorder table appropriately!} The twenty co-added tiles that contain regions with a
...
\software{Starlink \citep{Currie2015,2011ascl.soft10012V} , SMURF
